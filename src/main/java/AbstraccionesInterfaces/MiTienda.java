...
public class MiTienda {
    ...
    public static void main(String[] args) {
        ...
        listaProductos.sort((p1, p2) -> (p1.getPrecio() > p2.getPrecio()) ? 1 : -1);
        listaProductos.forEach(System.out::println);
        ...
        for (int i = 0; i < listaProductosEnvian.size(); i++) {
            if (listaProductosEnvian.get(i) instanceof LibroPapel) {
                ((LibroPapel) listaProductosEnvian.get(i)).enviar("efgkhkhkki");
            } else {
                ((Ropa)listaProductosEnvian.get(i)).enviar("efgkhkhkki");
            }
        }
